  ...
  return `
    <section class="reaction-panel decision-tray decision-tray--danger" aria-label="${t("reaction.title")}">
      <div class="decision-tray__header">
        <h3 class="reaction-panel__title">🛡️ ${t("reaction.title")}</h3>
      ...
      <div class="reaction-grid">
        ...
        <div class="reaction-card ${!canGuard ? "reaction-card--disabled" : ""}" data-reaction="guard">
          <div class="reaction-card__top">
            <div class="reaction-card__icon" aria-hidden="true">🛡️</div>
          ...
          <button
            type="button"
            class="btn btn--guard reaction-btn"
            data-choice="guard"
            data-reaction="guard"
        ...
        <div class="reaction-card reaction-card--challenge" data-reaction="challenge">
          ...
          <button
            type="button"
            class="btn btn--challenge reaction-btn"
            data-choice="challenge"
            data-reaction="challenge"
        ...
        <div class="reaction-card reaction-card--yield" data-reaction="yield">
          ...
          <button
            type="button"
            class="btn btn--yield reaction-btn"
            data-choice="yield"
            data-reaction="yield"
            ${isSubmitting ? "disabled" : ""}
          >
